...
module top(
	...
	// output	                   pre          			//sdram bank address
	
	output[5:0]						 seg_sel,				// LED segment select
	output[7:0]    				 seg_data  				// LED segment data
...
(
	...
	.de                         (                         ),
	.vout_data                  (vout_data                ),
	.line1               		 (line1							),// data_line1 for recognize
	.line2               		 (line2							),// data_line2 for recognize
	.prepared            		 (line_clk						),// data_prepared
	.row                 		 (row_h							)// row for recognize
);
...
// The video output timing generator and get the num in the video
video_process video_process_m0
(
	.video_clk                  (video_clk                ),
	.rst                        (~rst_n                   ),
	.line_clk                   (line_clk                 ),
